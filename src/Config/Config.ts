import { TalkyJSSkillConfig, TalkyJSSkillStage, TalkyJSErrorHandlerConfig } from '../framework/skillFactory.interface';
...
export class SkillConfig {
    ...
    private fillDefaultConfigProps(config?: TalkyJSSkillConfig) {
        ...
        const errorHandler = config && config.errorHandler
          ? config.errorHandler
          : {
              usePreset: true,
            };
